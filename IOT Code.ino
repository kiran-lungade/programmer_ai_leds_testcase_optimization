...
const char *ssid = "OnePlus11";  //ENTER YOUR WIFI SETTINGS
const char *password = "00000001";

//Web/Server address to read/write from 
const char *host = "192.168.135.154";   //IP address of server
...
void loop() {
 ...
 for (byte i = 0; i < mfrc522.uid.size; i++) {
  ...
  Link = "http://192.168.135.154/gatepass/postdemo.php" + getData;
//  Link = "http://192.168.135.154/gatepass/postdemo1.php" + getData;
